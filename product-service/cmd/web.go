...
import (
	...
	"github.com/kadekchresna/ecommerce/product-service/config"
	"github.com/kadekchresna/ecommerce/product-service/helper/logger"
	driver_db "github.com/kadekchresna/ecommerce/product-service/infrastructure/db"
	handler "github.com/kadekchresna/ecommerce/product-service/internal/v1/delivery/http"
	"github.com/kadekchresna/ecommerce/product-service/internal/v1/repository"
	"github.com/kadekchresna/ecommerce/product-service/internal/v1/usecase"
...
func run() {
	...
	handler.NewProductsHandler(v1, usecase.NewProductsUsecase(
		repository.NewProductRepository(db),
		repository.NewShopRepository(config.ShopServiceURL, config.AppStaticToken),
		repository.NewWarehouseRepository(config.WarehouseServiceURL, config.AppStaticToken),
	))
	// V1 Endpoints
