...
--
-- TOC entry 3418 (class 0 OID 35485)
-- Dependencies: 218
...
--
-- TOC entry 3415 (class 0 OID 34919)
-- Dependencies: 215
-- Data for Name: orders; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.orders (uuid, code, user_uuid, total_amount, expired_at, status, created_at, updated_at, created_by, updated_by, metadata) FROM stdin;
\.


--
-- TOC entry 3416 (class 0 OID 34932)
-- Dependencies: 216
-- Data for Name: orders_detail; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.orders_detail (uuid, product_uuid, product_title, product_price, quantity, sub_total, order_uuid) FROM stdin;
\.


--
-- TOC entry 3417 (class 0 OID 35441)
-- Dependencies: 217
